CREATE DATABASE  IF NOT EXISTS `yt_monitor` /*!40100 DEFAULT CHARACTER SET cp1250 */;
USE `yt_monitor`;
...
CREATE TABLE `pattern_words` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_pattern_words_pattern` FOREIGN KEY (`pattern_id`) REFERENCES `pattern` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `pattern_words` VALUES (1,1,'Человек',0.1,0.5);
...
-- Dump completed on 2018-03-28 13:11:35
