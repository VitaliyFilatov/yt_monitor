...
CREATE TABLE `pattern_video` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_pattern_video_pattern` FOREIGN KEY (`pattern_id`) REFERENCES `pattern` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `pattern_video` VALUES (1,1,'1111111111');
